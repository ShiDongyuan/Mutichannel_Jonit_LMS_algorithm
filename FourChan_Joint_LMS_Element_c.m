classdef FourChan_Joint_LMS_Element_c
	properties
		% 4-control filters 
		Wc_1
		Wc_2 
	...
	methods
		function obj = FourChan_Joint_LMS_Element_c(Len,Ls,Sec_1,Sec_2,Sec_3,Sec_4)
			obj.Len   = Len  ; 
			obj.Ls    = Ls   ;
			%-----------------
		...
		function [yt_1,yt_2,yt_3,yt_4,obj] = controller(obj, muw, xin_1, xin_2, xin_3, xin_4, e1, e2, e3, e4)
			...
			obj.Wc_1 = obj.Wc_1 + muw*(ef1 + ef2 + ef3 + ef4)*obj.Xd_1(obj.Ls:end-1);
            obj.Wc_2 = obj.Wc_2 + muw*(ef1 + ef2 + ef3 + ef4)*obj.Xd_2(obj.Ls:end-1);
			obj.Wc_3 = obj.Wc_3 + muw*(ef1 + ef2 + ef3 + ef4)*obj.Xd_3(obj.Ls:end-1);
			obj.Wc_4 = obj.Wc_4 + muw*(ef1 + ef2 + ef3 + ef4)*obj.Xd_4(obj.Ls:end-1);
		end
	end
end